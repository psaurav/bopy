...
def gen3fit(cfgfilename):
    ...
    if call == 'aphidc_flat_andro': 
        bg3f.aphidc_flat_andro(datalist, darkfile, srcplate_cfg, p)
    elif call == 'aphidc_flat_andro_udrot':
        bg3f.aphidc_flat_andro_udrot(datalist, darkfile, srcplate_cfg, p)
    elif call == 'aphidc_flat_andro_udrot2':
        bg3f.aphidc_flat_andro_udrot2(datalist, darkfile, srcplate_cfg, p)
    elif call == 'aphidc_flat_andro_udrot2_pickoff':
        p.pickoff = [int(v) for v in pl.get_val('GEN3FIT_PICKOFF').split()]
        bg3f.aphidc_flat_andro_udrot2_pickoff(datalist, darkfile, srcplate_cfg, p)
